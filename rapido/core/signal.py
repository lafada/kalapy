...
class Signal(object):
    ...
    def send(self, *args, **kw):
        ...
        Args:
            *args: to be passed to signal handlers
            **kw: to be passed to signal handlers

        Returns:
            list of results returned by all the handlers
        """
        result = []
...
def disconnect(signal, handler=None):
    """If handler is given then disconnect the handler from the
    specified signal else disconnect all the handlers of the given
    signal.
...
def send(signal, *args, **kw):
    ...
    Args:
        *args: to be passed to the signal handlers
        **kw: to be passed to the signal handlers

    Returns:
        list of the results of all the signal handlers
    """
    result = []
